...
map(config_personal, ~ render_from_list(.x, list_from_yaml = personal_list)) |> invisible()
```
...
map(config_chronology, ~ render_from_list(.x, list_from_yaml = chronology_list)) |> invisible()
```
...
map(config_summary, ~ render_from_list(.x, list_from_yaml = summary_list)) |> invisible()
```
...
map(config_links, ~ render_from_list(.x, list_from_yaml = data_list_from_yaml)) |> invisible()
```
