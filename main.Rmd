...
render_title(data_list_from_yaml, "links")

config_links <- yaml::read_yaml("config/links.yml")

map(config_links, ~ render_singletons_yml(.x, list_from_yaml = data_list_from_yaml)) |> invisible()
```
...
render_title(data_list_from_yaml, "development")

config_links <- yaml::read_yaml("config/development.yml")

map(data_list_from_yaml, \(y) {
...
render_title(data_list_from_yaml, "positions")
...
yaml_file <- paste0("data/", chapter, ".yml")

data_list_from_yaml <- read_yml_and_check_levels(yaml_file)

render_title(data_list_from_yaml, chapter)

config_links <- yaml::read_yaml(paste0("config/", chapter, ".yml"))
