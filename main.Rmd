...
``` {r, echo=F, results="asis"}
summaryCasted <- readDataTypes("summaryItem")

if (nrow(summaryCasted) > 0) {
  for (i in 1:nrow(summaryCasted)) {
    addFields(c(
      "summary6",
      # ,
      "summary2"
    ...
    xCasted = summaryCasted, xFielddata = fieldIts, xtitle = F, Section = F,
