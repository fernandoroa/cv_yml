...
DataCasted <- readDataTypes("personItem")

if (nrow(DataCasted) > 0) {
  for (i in 1:nrow(DataCasted)) {
    addFields("name", xCasted = DataCasted, xFielddata = fieldIts, xtitle = T, Section = F, separator = "")
    addFields(c("id", "idIssuePlace", "idIssueDate"), xCasted = DataCasted, xFielddata = fieldIts, xtitle = T, Section = F, separator = " ")
    addFields(c("profId", "profIdDate"), xCasted = DataCasted, xFielddata = fieldIts, xtitle = T, Section = F, separator = " ")
    addFields(c("birthdate", "birthCity"), xCasted = DataCasted, xFielddata = fieldIts, xtitle = T, Section = F, separator = " ")
    addFields(c("email", "skype", "phonewa", "address"),
      xCasted = DataCasted, xFielddata = fieldIts, xtitle = T, Section = F,
